...
WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_Comment_comment'), 'werwer')

WebUI.takeScreenshotAsCheckpoint('middlepage')

WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/div_Make Appointment                       _4e05d4'))

WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/button_Book Appointment'))

WebUI.takeScreenshotAsCheckpoint('resultpage')
