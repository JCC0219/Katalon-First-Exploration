...
WebUI.setText(findTestObject('Object Repository/Page_Automation Step by Step/input_Email_email123'), 'test@email.com')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Automation Step by Step/input_Password_psw'), 'apkyQXz/tUI=')
